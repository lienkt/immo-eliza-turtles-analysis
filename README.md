...
*Note: All columns are structured in lower_case. Missing or blank values are strictly set to `null` or `NaN` during the cleaning phase.*# immo-eliza-turtles-analysis
